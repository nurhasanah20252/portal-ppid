                ...
                <div className="max-w-3xl">
                    ...
                    <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                        <Link
                            ...
                            className="inline-flex items-center justify-center gap-2 rounded-lg bg-orange px-6 py-3 font-heading text-sm font-semibold text-white shadow-lg transition-all duration-200 hover:scale-[1.02] hover:bg-orange-light hover:shadow-xl sm:text-base"
                        >
                        ...
                        <Link
                            ...
                            className="inline-flex items-center justify-center gap-2 rounded-lg border-2 border-white/30 bg-white/10 px-6 py-3 font-heading text-sm font-semibold text-white backdrop-blur-sm transition-all duration-200 hover:border-white/50 hover:bg-white/20 sm:text-base"
                        >
